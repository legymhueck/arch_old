...
gdisk /dev/sda
o -> create GPT
sgdisk -n 1:0:+260M -t 1:ef00 -c 1:"EFI"   /dev/sda
...
pacstrap /mnt base base-devel linux linux-headers linux-firmware efibootmgr btrfs-progs vim dosfstools mtools sudo xdg-user-dirs xdg-utils sudo networkmanager
...
options cryptdevice=UUID=[UUID_von_/dev/sda3]:[Name_hinter_/dev/mapper/] root=/dev/mapper/arch rootflags=subvol=@root quiet rw
