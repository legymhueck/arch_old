...
pacstrap /mnt base base-devel linux linux-headers linux-firmware efibootmgr sudo vim btrfs-progs xdg-user-dirs git acpid polkit networkmanager intel-ucode
# systemd-resolvconf
# nss-mdns
